import type { Toolkit, ToolkitComponent } from "./types";

export function createToolkit(): Toolkit {
  const registry = new Map<string, ToolkitComponent<unknown>>();
  ...
  return {
    ...
    get<Props>(name: string): ToolkitComponent<Props> | undefined {
      return registry.get(name) as ToolkitComponent<Props> | undefined;
    },
