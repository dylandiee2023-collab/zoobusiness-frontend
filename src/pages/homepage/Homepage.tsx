...
const operations = [
  ...
  { icon: Package, title: "Products & Stock", text: "Keep products, stock and warehouse activity visible as your business moves." },
  { icon: Users, title: "Teams & Access", text: "Organize business users, roles and access without losing operational control." },
...
export function HomePage() {
  ...
  return (
    <main className="zb-homepage" style={{
      ...
      <section className="zb-hero" id="platform">
        ...
        <div className="zb-hero-visual" aria-label="Retail operations and automation illustration">
          <div className="zb-orbit zb-orbit-one" /><div className="zb-orbit zb-orbit-two" />
          <div className="zb-hero-network-line zb-line-a" /><div className="zb-hero-network-line zb-line-b" /><div className="zb-hero-network-line zb-line-c" />
          <div className="zb-hero-node zb-node-retail"><Store size={22} aria-hidden="true" /><span>Retail</span></div>
          <div className="zb-hero-node zb-node-inventory"><Package size={22} aria-hidden="true" /><span>Inventory</span></div>
          <div className="zb-hero-node zb-node-orders"><ClipboardList size={21} aria-hidden="true" /><span>Orders</span></div>
          <div className="zb-hero-node zb-node-team"><Users size={22} aria-hidden="true" /><span>Team</span></div>
          <div className="zb-hero-core"><img src={logo} alt="" /><strong>ZooBusiness</strong><span>Retail operating platform</span></div>
          <div className="zb-floating-card zb-floating-automation"><Zap size={15} aria-hidden="true" /> Automation ready</div>
          <div className="zb-floating-card zb-floating-orders"><BarChart3 size={16} aria-hidden="true" /> Business activity connected</div>
        </div>
      </section>

      <section className="zb-trust-strip" aria-label="ZooBusiness platform capabilities">
        <div className="zb-stat"><strong>1</strong><span>retail platform</span></div><div className="zb-stat"><strong>24/7</strong><span>digital access</span></div><div className="zb-stat"><strong>+</strong><span>automation-ready workflows</span></div>
      ...
      <section className="zb-section" id="operations">
        <div className="zb-section-heading"><div className="zb-eyebrow">RETAIL OPERATIONS</div><h2>Everything your retail business needs, connected.</h2><p>Build daily operations around one platform instead of stitching together disconnected tools.</p></div>
        <div className="zb-capability-grid">{operations.map(({ icon: Icon, title, text }) => <article className="zb-capability-card" key={title}><div className="zb-icon-box"><Icon size={21} aria-hidden="true" /></div><h3>{title}</h3><p>{text}</p><ArrowRight size={17} className="zb-card-arrow" aria-hidden="true" /></article>)}</div>
      </section>

      <section className="zb-ecosystem-section" id="businesses">
        <div className="zb-section-heading zb-section-heading-light"><div className="zb-eyebrow">BUILT FOR RETAIL BUSINESSES</div><h2>One business workspace. One operating picture.</h2><p>Manage the structure behind your retail business and keep the work your teams do connected.</p></div>
        <div className="zb-ecosystem-grid">
          <div className="zb-ecosystem-card"><div className="zb-icon-box zb-icon-box-light"><Store size={21} aria-hidden="true" /></div><h3>Business Workspace</h3><p>Keep your retail organization and operational structure in one place.</p></div>
          <div className="zb-ecosystem-card"><div className="zb-icon-box zb-icon-box-light"><Truck size={21} aria-hidden="true" /></div><h3>Stores & Branches</h3><p>Support branch-based operations with the right business structure around them.</p></div>
          <div className="zb-ecosystem-card"><div className="zb-icon-box zb-icon-box-light"><Package size={21} aria-hidden="true" /></div><h3>Stock Control</h3><p>Connect products, inventory and warehouse activity so teams can act from one picture.</p></div>
          <div className="zb-ecosystem-card"><div className="zb-icon-box zb-icon-box-light"><BarChart3 size={21} aria-hidden="true" /></div><h3>Business Insight</h3><p>Turn operational activity into clearer signals for planning and decisions.</p></div>
        </div>
      </section>
      ...
      <section className="zb-ai-section" id="resources">
        <div className="zb-ai-visual"><div className="zb-ai-panel"><BrainCircuit size={28} aria-hidden="true" /><span>CONNECTED OPERATIONS</span><strong>See the signals behind the work.</strong><div className="zb-ai-bars"><i /><i /><i /><i /><i /></div><small>Operational data, automation and insight working from the same foundation.</small></div></div>
